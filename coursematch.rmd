...
names(wharton_col) <- c("wharton_blue", 'wharton_red','midnight_blue','atlantic_blue','pacific_blue','bay_blue',
                        'evening_red','sunset_red','brick_red','heritage_red','night_stree','morning_yellow',
...
course_quality_to_price %>%
  ...
  hc_add_theme(hc_theme_merge(
    ...
    hc_theme(colors = wharton_col[c('wharton_blue','wharton_red','bay_blue','morning_yellow','college_gray',
